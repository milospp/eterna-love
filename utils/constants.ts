...
export const TUTORIAL_SLIDES: Tutorial = {

    'facebook': {
        default: [
            {
                title: 'Kliknite na vašu ikonicu gore desno',
                description: '',
                image: new URL('/public/tutorial/facebook_pc/FACEBOOK_PC_STEP_0.jpg', import.meta.url).href
            },
            {
                title: 'Izaberite podešavanja i privatnost',
                image: new URL('/public/tutorial/facebook_pc/FACEBOOK_PC_STEP_1.jpg', import.meta.url).href
            },
            {
                title: 'Potom kliknite na podešavanja',
                image: new URL('/public/tutorial/facebook_pc/FACEBOOK_PC_STEP_2.jpg', import.meta.url).href
            },
            {
                title: 'Na levoj strani kliknite na Meta Centar za naloge',
                image: new URL('/public/tutorial/facebook_pc/FACEBOOK_PC_STEP_3.jpg', import.meta.url).href
            },
            {
                title: 'Sa leve strane izaberite vaši podaci i dozvole',
                image: new URL('/public/tutorial/facebook_pc/FACEBOOK_PC_STEP_4.jpg', import.meta.url).href
            },
            {
                title: 'Upload the messages',
                image: new URL('/public/tutorial/facebook_pc/FACEBOOK_PC_STEP_5.jpg', import.meta.url).href
            },
            // {
            //     title: 'Upload the messages',
            //     image: new URL('/public/tutorial/facebook_pc/FACEBOOK_PC_STEP_6.jpg', import.meta.url).href
            // },
            {
                title: 'Upload the messages',
                image: new URL('/public/tutorial/facebook_pc/FACEBOOK_PC_STEP_7.jpg', import.meta.url).href
            },
            {
                title: 'Upload the messages',
                image: new URL('/public/tutorial/facebook_pc/FACEBOOK_PC_STEP_8.jpg', import.meta.url).href
            },
            {
                title: 'Upload the messages',
                image: new URL('/public/tutorial/facebook_pc/FACEBOOK_PC_STEP_9.jpg', import.meta.url).href
            },
            {
                title: 'Upload the messages',
                image: new URL('/public/tutorial/facebook_pc/FACEBOOK_PC_STEP_10.jpg', import.meta.url).href
            }
        ]
    },
    ...
    'instagram': {
        default: [
            {
                title: 'Korak 1',
                description: 'Go to your Facebook settings and download your data. Make sure to select the messages option.',
                image: new URL('/public/tutorial/instagram_pc/INSTAGRAM_PC_STEP_1.jpg', import.meta.url).href
            },
            {
                title: 'Korak 2',
                description: 'Unzip the downloaded file and locate the messages folder.',
                image: new URL('/public/tutorial/instagram_pc/INSTAGRAM_PC_STEP_1.jpg', import.meta.url).href
            },
            {
                title: 'Korak 3',
                description: 'Upload the messages folder here.',
                image: new URL('/public/tutorial/instagram_pc/INSTAGRAM_PC_STEP_1.jpg', import.meta.url).href
            }
        ]
    },
        ...
        default: [
            {
                title: 'ASD',
                description: 'asd',
                image: new URL('/public/poster/themes/pastel_orange.png', import.meta.url).href
