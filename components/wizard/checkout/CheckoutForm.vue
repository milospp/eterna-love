    ...
    <div class="space-y-8 bg-gray-100 rounded-lg p-8 shadow-lg shadow-black/20">
        ...
        <Transition name="fade">
            <div v-if="!showContact">
                <Transition name="fade" mode="out-in">
                    <WizardCheckoutShipAddressForm v-if="showShipAddress" @saved="savedShipAddress" />
        ...
        <Transition name="fade">
            <div v-if="!showContact && !showShipAddress && !showPaymentOptions">
                ...
                <SharedButtonsAction @click="placeOrder" class="px-24 py-4 mx-auto font-bold">Poruči
                </SharedButtonsAction>
            </div>
        </Transition>
    </div>
...
const showShipAddress = ref(true);
