<template>
    ...
    <template v-else>
        ...
        <!-- <div class="mt-1 text-slate-300 opacity-70 text-sm font-thin">
            <span><svg class="inline" xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24">
