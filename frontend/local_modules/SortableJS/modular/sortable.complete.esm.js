  ...
  Swap.prototype = {
    ...
    drop({
      ...
      if (options.swap || putSortable && putSortable.options.swap) {
        ...
        const onBeforeSwap = options.onBeforeSwap;
        let continueSwap = true;
        if (onBeforeSwap) {
          continueSwap = onBeforeSwap.call(this, dragEl, swapValidEl);
          if (continueSwap === undefined) continueSwap = true;
        }
        if (continueSwap) {
